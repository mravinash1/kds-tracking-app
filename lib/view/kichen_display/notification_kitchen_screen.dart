...
class NotificationKitchenScreen extends StatefulWidget {
  const NotificationKitchenScreen({super.key});

  @override
  State<NotificationKitchenScreen> createState() => _NotificationKitchenScreenState();
}

class _NotificationKitchenScreenState extends State<NotificationKitchenScreen> {
  ...
  double textScale = MediaQuery.of(context).textScaleFactor;
    ...
    return  Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Restaurant',style: TextStyle(fontWeight: FontWeight.w500),),
