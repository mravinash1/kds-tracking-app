...
import 'package:shared_preferences/shared_preferences.dart';
  ...
  //         int orderId = kotData.shopvno ?? 0; // Use shopvno as unique key
...
Future fetchData() async {
  ...
  try {
    ...
    if (data != null) {
      ...
      Map<String, FilterModelOfHotel> groupedOrders = {}; // Changed to String key
...
//       roomnoview: orderGroup.roomnoview,
//       date: _formatDate(orderGroup.orders.first.kot.orddate.toString()),
//       time: orderGroup.orders.first.kot.orddate.toString(),
//       items: orderGroup.orders.map((order) {
//         return {
//           'name': order.kot.rawname,
//           'qty': order.kot.qty,
//         };
//       }).toList(),
//     );
