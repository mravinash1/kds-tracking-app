...
List<FilterModelOfHotel> filterModelOfKdsFromJson(String str) => List<FilterModelOfHotel>.from(json.decode(str).map((x) => FilterModelOfHotel.fromJson(x)));

String filterModelOfKdsToJson(List<FilterModelOfHotel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class FilterModelOfHotel {
  ...
  factory FilterModelOfHotel.fromJson(Map<String, dynamic> json) => FilterModelOfHotel(
...
class KotDatas {
   ...
   //final int? shopvno;
    ...
    factory KotDatas.fromRawJson(String str) => KotDatas.fromJson(json.decode(str));
