...
class PrinterSelectionHotelDialog extends StatelessWidget {
  final BluetoothPrinterHotel printerManager;

  const PrinterSelectionHotelDialog({super.key, required this.printerManager});
