...
import 'package:shared_preferences/shared_preferences.dart';
  ...
  class BluetoothPrinterManager extends GetxController {
  ...
  Future<List<int>> generateReceipt({
    ...
    bytes += generator.text("KITCHEN ORDER", 
        styles: PosStyles(align: PosAlign.center, bold: true, height: PosTextSize.size2));
         bytes += generator.text("KOT: $shopNumber", 
    ...
    bytes += generator.row([
      ...
      PosColumn(text: tableName, width: 6),
    ]);
    
    bytes += generator.row([
      PosColumn(text: 'Waiter', width: 6),
      PosColumn(text: waiterName, width: 6),
    ]);
